...
## PL/SQL Types and Programs

Sub Paths:
- **binary_types**: PL/SQL function example with binary types parameter.
- **bulk_processing**: PL/SQL types and PL/SQL programs for Bulk operations.
- **collections**: PL/SQL collection types and PL/SQL programs for collection operations.
...
- Compile all PL/SQL types and programs to the Oracle database.
